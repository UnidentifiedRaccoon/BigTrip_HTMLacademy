...
const createTripInfoDescriptionTemplate = () => {
    return `
...
const createTripInfoTemplate = () => {
    ...
    return `
      <section class="trip-main__trip-info  trip-info">
            ${createTripInfoDescriptionTemplate()}
...
const createTripEventsListTemplate = () => {
    ...
    for (let i = 0; i < EVENTS_AMOUNT; i++) {
        events.push(createTripEventItemTemplate())
    }
    return `
...
const createTripDayItemInfoTemplate = () => {
    return `
      <div class="day__info">
...
const createTripDaysListTemplate = () => {
    ...
    for (let i = 0; i < DAYS_AMOUNT; i++) {
        days.push(createTripDayItemTemplate())
    }
    return `
      <ul class="trip-days">
        ${days.join('')}  
...
render(tripEventsElement, createEditTemplate())
